                                    ...
                                    <tbody>
                                        <form action="{{ route('artikels.update', $artikels->id) }}" method="post"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('judul') is-invalid @enderror " name="judul" placeholder="Edit judul artikel"
                                        ...
                                        @enderror
                                            ...
                                            <div class="mb-3">
                                                <label for="">Isi</label>
                                                <input type="text" class="form-control @error('isi') is-invalid @enderror" name="isi" placeholder="Edit isi artikel"
                                                    value="{{ $artikels->isi }}">
                                                     @error('isi')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <img src="{{ asset('storage/artikels/' . $artikels->foto) }}"
                                                    alt="" style="width: 90px; height: 90px;"><br>
                                                <input type="file"
