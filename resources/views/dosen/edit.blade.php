                                ...
                                <form action="{{ route('dosen.update', $dosen->id) }}" method="post"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            name="nama_dosen" placeholder="Edit nama dosen"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control @error('email') is-invalid @enderror"
                                            name="jabatan" placeholder="Edit jabatan">
                                            <option value="Asisten ahli"
                                                {{ $dosen->jabatan == 'Asisten ahli' ? 'selected' : '' }}>Asisten ahli
                                            </option>
                                            <option value="Lektor"
                                                {{ $dosen->jabatan == 'Lektor' ? 'selected' : '' }}>
                                                Lektor </option>
                                            <option value="Kepala lektor"
                                                {{ $dosen->jabatan == 'Kepala lektor' ? 'selected' : '' }}>Kepala
                                                lektor
                                            </option>
                                            <option value="Profesor"
                                                {{ $dosen->jabatan == 'Profesor' ? 'selected' : '' }}>Profesor</option>
                                        </select>
                                        @error('jabatan')
                                            <div class="invalid-feedback">{{ $message }}
                                            </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control  @error('status') is-invalid @enderror"
                                            name="status" placeholder="Edit status">
                                            <option value="Dosen tetap"
                                                {{ $dosen->status == 'Dosen tetap' ? 'selected' : '' }}>Dosen tetap
                                            </option>
